...
import com.example.HomeFinances.Services.InvestmentService;
...
public class InvestmentController {
    ...
    {
        try {
            List<Investment> response = service.list();
    ...
    {
        try {
            Investment response = service.findById(id);
            if (response == null)
            {
    ...
    @PostMapping("/")
    public ResponseEntity<?> create(@RequestBody Investment input){
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable long id, @RequestBody Investment input)
    {
        try {
