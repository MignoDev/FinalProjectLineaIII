...
import com.example.HomeFinances.Services.EarnInvestmentService;
...
@RestController
@RequestMapping("/api/earninvestment")
public class EarnInvestmentController {
    @Autowired
    public EarnInvestmentService service;
    ...
    {
        try {
            List<EarnInvestment> response = service.list();
    ...
    {
        try {
            EarnInvestment response = service.findById(id);
            if (response == null)
            {
    ...
    @PostMapping("/")
    public ResponseEntity<?> create(@RequestBody EarnInvestment input){
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable long id, @RequestBody EarnInvestment input)
    {
        try {
